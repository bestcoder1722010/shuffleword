let sword = ["arduino","python","javascript","uno","chess","bluestrip","flooring","ludo","coding","coffee","encourage","happy","exam","flamingo","india","bestfriend","parents","arduino","python","javascript","uno","chess","bluestrip","flooring","ludo","coding","coffee","encourage","happy","exam","flamingo","india","bestfriend","parents"];
let sco = 2;
let score = 0;
let play = false;
let crneword = () => {
